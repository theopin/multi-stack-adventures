...
public class TopkCommonWords {
    ...
    public static int kItrerations;
    ...
    public static void scanStopwords(String stopwordFileName) throws FileNotFoundException {
        ...
        File stopwordFile = new File(stopwordFile);
    ...
    public static class TokenizerMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        private HashMap<String, int> wordCountTracker = new HashMap<String, int>(); 
        ...
        public void map(Object key, Text value, Context context) 
            ...
            while (itr.hasMoreTokens()) {
                ...
                for (Map.Entry<String,int> wordCountPair : wordCountTracker.entrySet()) {
